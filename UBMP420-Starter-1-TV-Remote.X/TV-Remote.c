/*==============================================================================
 ...
 This starter programming project for the mirobo.tech UBMP4 demonstrates how
 to modulate an LED to create SONY-formatted (SIRC) IR remote control codes.
 Using the concepts introduced in this program and following the website
 activity and debugging techniques, you should be able to easily modify this
 starter program to create IR transmissions modulated using other IR protocols.
==============================================================================*/
 ...
 *    uses a 38kHz carrier, and the Philips RC-6 protocol uses a 36kHz carrier.
 *    Create and debug a pulse function to produce modulated pulses at one of
 ...
 * 
 * 3. Determine the number of pulses required to create a start bit, a zero bit,
 *    and a one bit for the NEC protocol using a 38kHz carrier. 
 * 
 * 4. You can clip an oscilloscope lead to the output pin of the UBMP4 IR
 *    demodulator (U2) to view remote control pulses from many remote control
 *    transmitters without needing to write any software code. See if you can
 *    decode and reverse engineer the IR protocol transmitted by a remote
 *    control transmitter that you own or have access to.
 * 
 ...
 *
 * 6. IR protocols can be created to implement your own controllable devices.
 *    Think about the types of commands you would need to encode to remotely
 *    control a robot, or a string of NeoPixel LEDs.
 */
